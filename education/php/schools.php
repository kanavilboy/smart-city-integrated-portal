...
$totalSchools = $conn->query("SELECT COUNT(*) FROM institutions WHERE type = 'School'")->fetchColumn();
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active"><a class="nav-link" href="schools.php">Schools</a></li>
  ...
  <div class="page-banner overlay-dark bg-image" style="background-image: url(../assets/img/school-banner.jpg);">
    <div class="banner-section">
      <div class="container text-center wow fadeInUp">
        <h1 class="display-4 mb-4">Schools in Our City</h1>
    ...
    <div class="container">
      ...
      <div class="row">
        <?php if (empty($schools)): ?>
          <div class="col-12">
            <div class="alert alert-info">No schools found in our database.</div>
          </div>
        <?php else: ?>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="card school-card h-100 shadow-sm">
              <div class="position-relative">
                ...
                <?php endif; ?>
                <span class="badge badge-school position-absolute" style="top: 10px; right: 10px;">School</span>
              </div>
              <div class="card-body">
