...
$totalSchools = $conn->query("SELECT COUNT(*) FROM institutions WHERE type = 'College'")->fetchColumn();
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active"><a class="nav-link" href="colleges.php">Colleges</a></li>
  ...
  <div class="page-banner overlay-dark bg-image" style="background-image: url(../assets/img/school-banner.jpg);">
    <div class="banner-section">
      <div class="container text-center wow fadeInUp">
        <h1 class="display-4 mb-4">Colleges in Our City</h1>
    ...
    <div class="container">
      ...
      <div class="row">
        <?php if (empty($schools)): ?>
          <div class="col-12">
            <div class="alert alert-info">No colleges found in our database.</div>
          </div>
        <?php else: ?>
