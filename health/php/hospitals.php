      ...
      <div class="container text-center wow fadeInUp">
        <nav aria-label="Breadcrumb">
          <ol class="breadcrumb breadcrumb-dark bg-transparent justify-content-center py-0 mb-2">
            <li class="breadcrumb-item"><a href="health.php">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">Hospitals</li>
          </ol>
        </nav>
        <h1 class="font-weight-normal">TOP HOSPITALS</h1>
      </div> <!-- .container -->
    </div> <!-- .banner-section -->
  </div> <!-- .page-banner -->
                ...
                ?>
                    <div class="col-md-6 col-lg-4 py-3 wow zoomIn">
                        <div class="card-doctor">
                            ...
                            <div class="body">
                                <p class="text-xl mb-0"><a href="appointment.php?hospital_id=<?php echo $hospital['id']; ?>">
								<?php echo htmlspecialchars($hospital['hospital_name']); ?></p>
