...
// Check if cylinder ID is provided
if (!isset($_GET['id'])) {
...
// Fetch the cylinder details
$stmt = $conn->prepare("SELECT * FROM gas_cylinders WHERE id = :id AND agency_id = :agency_id");
...
if (!$cylinder) {
    $_SESSION['error_message'] = "Cylinder not found or you don't have permission to edit it.";
    header("Location: inventory.php");
    exit();
}

// Initialize variables with current cylinder data
$type = $cylinder['type'];
$price = $cylinder['price'];
$stock = $cylinder['stock_quantity'];
$description = $cylinder['description'];
$is_available = $cylinder['is_available'];
$errors = array();
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        try {
            $stmt = $conn->prepare("UPDATE gas_cylinders 
                                   SET type = :type, 
                                       price = :price, 
            ...
            $_SESSION['success_message'] = 'Cylinder updated successfully!';
            header("Location: inventory.php");
            exit();
        } catch (PDOException $e) {
            $errors['database'] = 'Error updating cylinder: ' . $e->getMessage();
        }
    }
}
?>
...
<head>
    ...
    <title>Edit Cylinder - Gas Agency</title>
    <!-- BOOTSTRAP STYLES-->
    ...
    <div id="wrapper">
            ...
            <div class="adjust-nav">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">
                        <?php echo htmlspecialchars($agency_name); ?> - Edit Cylinder
                    </a>
                </div>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2>EDIT CYLINDER TYPE</h2>
                        <h5>Update cylinder details in your inventory</h5>
                    </div>
                </div>
                <!-- /. ROW  -->
                <hr />
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="fa fa-edit"></i> Edit Cylinder Details
                            </div>
                            <div class="panel-body">
                                <form method="POST" action="edit_cylinder.php?id=<?php echo $cylinder_id; ?>">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fa fa-save"></i> Update Cylinder
                                        </button>
