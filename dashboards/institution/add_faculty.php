...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        try {
            $stmt = $conn->prepare("INSERT INTO institution_faculty 
                (name, email, phone_number, department, position, institution_id) 
                VALUES (?, ?, ?, ?, ?, ?)");
            $stmt->execute(array(
                $name, 
                $email, 
            ...
            if ($e->errorInfo[1] == 1062) { // Duplicate entry (unique constraint)
                ...
                $errors[] = "Error adding faculty member: " . $e->getMessage();
            }
        }
    }
}
...
<head>
    ...
    <title>Add Faculty - <?php echo htmlspecialchars($institution_name); ?></title>
    <!-- BOOTSTRAP STYLES-->
                                ...
                                <form method="POST" action="">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" 
                                                    value="<?php echo htmlspecialchars(isset($_POST['name']) ? $_POST['name'] : ''); ?>" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="tel" name="phone_number" class="form-control" 
                                                    value="<?php echo htmlspecialchars(isset($_POST['phone_number']) ? $_POST['phone_number'] : ''); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="position" class="form-control" 
                                                    value="<?php echo htmlspecialchars(isset($_POST['position']) ? $_POST['position'] : ''); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fa fa-save"></i> Save Faculty Member
                                        </button>
